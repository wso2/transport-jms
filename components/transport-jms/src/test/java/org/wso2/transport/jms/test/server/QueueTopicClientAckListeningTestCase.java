...
package org.wso2.transport.jms.test.server;
...
import org.wso2.transport.jms.test.util.TestMessageListener;
...
public class QueueTopicClientAckListeningTestCase {
    ...
    public void setUp() throws JMSConnectorException {
        queueListeningParameters = JMSTestUtils
                .createJMSParameterMap(JMSTestConstants.QUEUE_NAME_2, JMSTestConstants.QUEUE_CONNECTION_FACTORY,
                        JMSConstants.DESTINATION_TYPE_QUEUE, JMSConstants.CLIENT_ACKNOWLEDGE_MODE);
        topicListeningParameters = JMSTestUtils
                .createJMSParameterMap(JMSTestConstants.TOPIC_NAME_1, JMSTestConstants.TOPIC_CONNECTION_FACTORY,
                        JMSConstants.DESTINATION_TYPE_TOPIC, JMSConstants.CLIENT_ACKNOWLEDGE_MODE);
    ...
    public void queueListeningTestCase() throws JMSConnectorException, InterruptedException, JMSException {
        ...
        jmsServer.publishMessagesToQueue(JMSTestConstants.QUEUE_NAME_2, 10);
        Assert.assertTrue(queueTestMessageProcessor.getCount() > 10,
                "Expected message count is not received when " + "listening to queue " + JMSTestConstants.QUEUE_NAME_2);
    ...
    public void topicListeningTestCase() throws JMSConnectorException, InterruptedException, JMSException {
        ...
        Assert.assertTrue(topicTestMessageProcessor.getCount() > 10,
                "Expected message count is not received when " + "listening to topic " + JMSTestConstants.TOPIC_NAME_1);
