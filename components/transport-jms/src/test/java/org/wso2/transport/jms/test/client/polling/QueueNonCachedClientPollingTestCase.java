...
/**
 * Test case for queue polling NonCached.
 */
public class QueueNonCachedClientPollingTestCase {
    ...
    public void setUp() throws JMSConnectorException, InterruptedException, JMSException {
        ...
        jmsClientParameters.put(JMSConstants.PARAM_JMS_CACHING, Boolean.FALSE.toString());
     ...
     * non-cached interface and validate the number of produced messages.
     *
    ...
    @Test(groups = "jmsPolling",
          description = "Queue Polling non-cached test case")
    public void queueNonCachedPollingTestCase()
